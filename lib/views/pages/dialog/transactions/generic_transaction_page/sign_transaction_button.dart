...
class _SignTransactionButton extends State<SignTransactionButton> {
  ...
  @override
  void initState() {
    _handleFormControllerChanged();
    widget.msgFormController.addListener(_handleFormControllerChanged);
    super.initState();
  }
  ...
  void _handleFormControllerChanged() {
    String? formErrorMessage = widget.msgFormController.errorMessage;
    if (mounted) {
      setState(() {
