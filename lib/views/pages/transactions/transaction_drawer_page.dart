...
class TransactionDrawerPage extends StatefulWidget {
  final TxListItemModel txListItemModel;

  const TransactionDrawerPage({
    required this.txListItemModel,
    Key? key,
  }) : super(key: key);

  @override
  State<StatefulWidget> createState() => _TransactionDrawerPage();
}

class _TransactionDrawerPage extends State<TransactionDrawerPage> {
  @override
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        MyTransactionStatusChip(txStatusType: txListItemModel.txStatusType),
        divider,
          ...
          children: <Widget>[
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: model.approvalStatusBool ? DesignColors.greenStatus1.withAlpha(20) : DesignColors.redStatus1.withAlpha(20),
                borderRadius: BorderRadius.circular(4),
              ),
              child: Text(
                model.approvalStatusBool ? S.of(context).transactionDetailsDrawerApprovalStatusYes : S.of(context).transactionDetailsDrawerApprovalStatusNo,
