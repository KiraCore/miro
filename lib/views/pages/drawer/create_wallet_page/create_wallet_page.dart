...
class _CreateWalletPage extends State<CreateWalletPage> {
  ...
  ValueNotifier<UnsafeWallet?> walletNotifier = ValueNotifier<UnsafeWallet?>(null);
        ...
        return SizedBox(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              ValueListenableBuilder<UnsafeWallet?>(
  ...
  Future<void> _createNewWallet() async {
    ...
    walletNotifier.value = unsafeWallet;
    publicAddressTextController.textController.text = unsafeWallet.address.bech32Address;
