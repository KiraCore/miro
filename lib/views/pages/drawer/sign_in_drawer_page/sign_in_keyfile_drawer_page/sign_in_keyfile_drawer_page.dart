...
class _SignInKeyfileDrawerPage extends State<SignInKeyfileDrawerPage> {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<SignInKeyfileDrawerPageCubit, SignInKeyfileDrawerPageState>(
      bloc: signInKeyfileDrawerPageCubit,
      listener: _listenLoginPageStateChange,
      builder: (BuildContext context, SignInKeyfileDrawerPageState signInKeyfileDrawerPageState) {
        return Column(
          ...
          children: <Widget>[
            ...
            BlocProvider<AKiraDropzoneCubit<KeyfileDropzoneState>>(
              ...
              child: BlocBuilder<KeyfileDropzoneCubit, KeyfileDropzoneState>(
                ...
                builder: (BuildContext context, KeyfileDropzoneState keyfileDropzoneState) {
                  ...
                  return KiraDropzone<KeyfileDropzoneState>(
                    width: double.infinity,
                    height: 128,
                    emptyLabel: S.of(context).keyfileDropHere,
                    kiraDropzoneCubit: keyfileDropzoneCubit,
                    errorMessage: _selectDropzoneErrorMessage(keyfileExceptionType),
                    filePreviewBuilder: (AKiraDropzoneState kiraDropzoneState, String? errorMessage) {
                      return KeyfileDropzonePreview(
                        kiraDropzoneState: kiraDropzoneState,
            ...
            KiraElevatedButton(
              onPressed: signInKeyfileDrawerPageState.decryptedKeyfileModel != null ? () => _pressSignInButton(signInKeyfileDrawerPageState) : null,
              disabled: signInKeyfileDrawerPageState.decryptedKeyfileModel == null,
  ...
  void _listenLoginPageStateChange(BuildContext context, SignInKeyfileDrawerPageState signInKeyfileDrawerPageState) {
  ...
  String? _selectDropzoneErrorMessage(KeyfileExceptionType? keyfileExceptionType) {
    switch (keyfileExceptionType) {
      case KeyfileExceptionType.unsupportedVersion:
        return S.of(context).keyfileErrorUnsupportedVersion;
      case KeyfileExceptionType.invalidKeyfile:
  ...
  String? _selectTextFieldErrorMessage(KeyfileExceptionType? keyfileExceptionType) {
    ...
    switch (keyfileExceptionType) {
      case KeyfileExceptionType.wrongPassword:
        return S.of(context).keyfileErrorWrongPassword;
      default:
        return null;
    }
  }
