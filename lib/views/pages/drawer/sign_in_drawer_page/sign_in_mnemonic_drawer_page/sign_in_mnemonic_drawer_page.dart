...
class SignInMnemonicDrawerPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<MnemonicGridCubit>(
      create: (_) => MnemonicGridCubit()..init(initialMnemonicGridSize: 24),
...
class _ContentState extends State<_Content> {
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          if (loadingStatusBool)
            ...
            MnemonicGrid(mnemonicGridCubit: context.read<MnemonicGridCubit>()),
          const SizedBox(height: 24),
  ...
  Future<Wallet?> _generateWallet() async {
    Mnemonic? mnemonic = context.read<MnemonicGridCubit>().buildMnemonicObject();
    if (mnemonic == null) {
      return null;
    }
