...
import 'package:miro/shared/controllers/menu/balances_page/balances_list_controller.dart';
...
import 'package:miro/views/widgets/kira/kira_list/components/list_last_block_time_widget.dart';
...
import 'package:miro/views/widgets/kira/kira_list/list_search_widget.dart';
        ...
        KiraInfinityList<BalanceModel>(
          ...
          itemBuilder: (BalanceModel balanceModel) {
            return BalanceListItemBuilder(
              key: Key(balanceModel.tokenAmount.tokenAliasModel.lowestTokenDenomination.name),
