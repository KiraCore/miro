...
class _BlocksPageState extends State<BlocksPage> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget listHeaderWidget = BlocksListItemDesktopLayout(
      height: 64,
      ageWidget: Text(S.of(context).blocksDateTime, style: textTheme.bodySmall!.copyWith(color: DesignColors.white1)),
      hashWidget: Text(S.of(context).blocksHash, style: textTheme.bodySmall!.copyWith(color: DesignColors.white1)),
      heightWidget: Text(S.of(context).blocksHeight, style: textTheme.bodySmall!.copyWith(color: DesignColors.white1)),
      kiraToolTipWidget: const SizedBox(width: 50),
      proposerWidget: Text(S.of(context).blocksProposer, style: textTheme.bodySmall!.copyWith(color: DesignColors.white1)),
      txCountWidget: Text(S.of(context).blocksTxCount, style: textTheme.bodySmall!.copyWith(color: DesignColors.white1)),
    );
