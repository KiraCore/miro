...
class BlockListTitleMobile extends StatefulWidget {
  final int pageSize;
  ...
  @override
  State<BlockListTitleMobile> createState() => _BlockListTitleMobileState();
}

class _BlockListTitleMobileState extends State<BlockListTitleMobile> {
