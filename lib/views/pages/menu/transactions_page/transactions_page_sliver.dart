...
class TransactionsPageSliver extends StatefulWidget {
  final BlockModel? blockModel;
  final ScrollController scrollController;

  const TransactionsPageSliver({
  ...
  @override
  State<StatefulWidget> createState() => _TransactionsPageSliver();
}

class _TransactionsPageSliver extends State<TransactionsPageSliver> {
