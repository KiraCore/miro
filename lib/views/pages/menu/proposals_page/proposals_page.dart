...
class _ProposalsPageState extends State<ProposalsPage> {
  ...
  final SortBloc<ProposalModel> sortBloc = SortBloc<ProposalModel>(
    defaultSortOption: ProposalsSortOptions.sortByTop.reversed(),
  );
  ...
  Widget build(BuildContext context) {
    ...
    Widget listHeaderWidget = ProposalListItemDesktopLayout(
      height: 64,
      idWidget: Text(S.of(context).proposalsId, style: textTheme.caption!.copyWith(color: DesignColors.white1)),
      statusWidget: Text(S.of(context).proposalsStatus, style: textTheme.caption!.copyWith(color: DesignColors.white1)),
      titleWidget: Text(S.of(context).proposalsTitle, style: textTheme.caption!.copyWith(color: DesignColors.white1)),
      tooltipWidget: const SizedBox(width: 50, height: 50),
      typesWidget: Text(S.of(context).proposalsTypes, style: textTheme.caption!.copyWith(color: DesignColors.white1)),
      votingEndWidget: Text(S.of(context).proposalsVotingEndTime, style: textTheme.caption!.copyWith(color: DesignColors.white1)),
    );
