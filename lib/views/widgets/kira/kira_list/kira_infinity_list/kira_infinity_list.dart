        ...
        child: Container(
          ...
          child: BlocBuilder<InfinityListBloc<T>, AListState>(
            builder: (BuildContext context, AListState state) {
              ...
              } else if (state is ListDisconnectedState) {
                return ListErrorWidget(errorMessage: 'No interx connection', minHeight: minHeight);
              }
              return ListErrorWidget(errorMessage: 'Unknown error $state', minHeight: minHeight);
            },
          ),
        ),
      ),
