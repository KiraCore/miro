...
class ControllableExpansionTile extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => ControllableExpansionTileState();
}

class ControllableExpansionTileState extends State<ControllableExpansionTile> with SingleTickerProviderStateMixin {
  ...
  /// Author: Dominik Pajak
  /// This widget is created from [ExpansionTile] class
  /// Below are kira custom methods
  void expand() {
    _setExpanded(true);
  }
