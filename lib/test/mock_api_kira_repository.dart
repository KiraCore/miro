...
import 'package:miro/test/mocks/api_kira/mock_api_kira_governance_proposal.dart';
import 'package:miro/test/mocks/api_kira/mock_api_kira_governance_proposals.dart';
import 'package:miro/test/mocks/api_kira/mock_api_kira_governance_voters.dart';
import 'package:miro/test/mocks/api_kira/mock_api_kira_governance_votes.dart';
    ...
    if (responseExistsBool) {
      ...
      switch (networkUri.host) {
        case 'invalid.kira.network':
          ...
          break;
        default:
          response = MockApiKiraGovernanceProposal.defaultResponse as T;
      }
      return Response<T>(
        statusCode: 200,
        data: response,
    ...
    if (responseExistsBool) {
      ...
      switch (networkUri.host) {
        case 'invalid.kira.network':
          ...
          break;
        default:
          response = MockApiKiraGovernanceProposals.defaultResponse as T;
      }
      return Response<T>(
        statusCode: 200,
        data: response,
    ...
    if (responseExistsBool) {
      ...
      switch (networkUri.host) {
        case 'invalid.kira.network':
          ...
          break;
        default:
          response = MockApiKiraGovernanceVotes.defaultResponse as T;
      }
      return Response<T>(
        statusCode: 200,
        data: response,
    ...
    if (responseExistsBool) {
      ...
      switch (networkUri.host) {
        case 'invalid.kira.network':
          ...
          break;
        default:
          response = MockApiKiraGovernanceVoters.defaultResponse as T;
      }
      return Response<T>(
        statusCode: 200,
        data: response,
