...
class Properties extends Equatable {
  ...
  final String minProposalEnacmentBlocks;
  ...
  const Properties({
    ...
    required this.minProposalEnacmentBlocks,
  ...
  factory Properties.fromJson(Map<String, dynamic> json) {
    return Properties(
      ...
      minProposalEnacmentBlocks: json['min_proposal_enactment_blocks'] as String,
