...
abstract class _WithdrawsService {
  Future<WithdrawsResp?> getAccountWithdraws(WithdrawsReq withdrawsReq, {Uri? optionalNetworkUri});
...
class WithdrawsService implements _WithdrawsService {
  ...
  @override
  Future<WithdrawsResp?> getAccountWithdraws(WithdrawsReq withdrawsReq, {Uri? optionalNetworkUri}) async {
