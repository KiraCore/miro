...
class QueryBalanceService implements _IQueryBalanceService {
  ...
  @override
  Future<List<BalanceModel>> getBalanceModelList(QueryBalanceReq queryBalanceReq, {Uri? optionalNetworkUri}) async {
    ...
    for (Balance balance in queryBalanceResp.balances) {
      TokenAliasModel tokenAliasModel = tokenAliasModels.firstWhere((TokenAliasModel e) {
        return e.lowestTokenDenomination.name == balance.denom;
      ...
      balanceModelList.add(BalanceModel(tokenAmount: tokenAmount));
    }
