...
class QueryUndelegationsService implements _IQueryUndelegationsService {
  ...
  Future<PageData<UndelegationModel>> getUndelegationModelList(QueryUndelegationsReq queryUndelegationsReq,
    ...
    Response<dynamic> response =
        await _apiKiraRepository.fetchQueryUndelegations<dynamic>(ApiRequestModel<QueryUndelegationsReq>(
    ...
    try {
      QueryUndelegationsResp queryUndelegationsResp =
          QueryUndelegationsResp.fromJson(response.data as Map<String, dynamic>);
      List<UndelegationModel> stakingModelList =
          queryUndelegationsResp.undelegations.map(UndelegationModel.fromDto).toList();
      ...
      AppLogger().log(
          message: 'QueryUndelegationsService: Cannot parse getUndelegationModelList() for URI $networkUri ${e}',
