...
class QueryDelegationsService implements _IQueryDelegationsService {
  ...
  Future<PageData<ValidatorStakingModel>> getValidatorStakingModelList(QueryDelegationsReq queryDelegationsReq,
    ...
    Response<dynamic> response =
        await _apiKiraRepository.fetchQueryDelegations<dynamic>(ApiRequestModel<QueryDelegationsReq>(
    ...
    try {
      ...
      List<ValidatorStakingModel> stakingModelList =
          queryDelegationsResp.delegations.map(ValidatorStakingModel.fromDto).toList();
      ...
      AppLogger().log(
          message: 'QueryDelegationsService: Cannot parse getValidatorStakingModelList() for URI $networkUri ${e}',
