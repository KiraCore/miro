...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(amount) => "Tip must be greater or equal ${amount}";

  static String m2(separator, networkName, parsedRemainingTime) =>
      "Connecting to <${networkName}>${separator} Please wait... ${parsedRemainingTime}";

  static String m3(errorsCount) => "Found ${errorsCount} problems with server";

  static String m4(latestBlockTime) =>
  ...
  static String m5(availableAmountText, tokenDenominationModelName) =>
      "Available: ${availableAmountText} ${tokenDenominationModelName}";

  static String m6(hash) => "Transaction hash: 0x${hash}";

  static String m7(amount) => "+ ${amount} more";

  static String m8(widgetFeeTokenAmountModel) =>
      "Transaction fee ${widgetFeeTokenAmountModel}";

  static String m9(txMsgType) => "Preview for ${txMsgType} unavailable";

  static String m10(selected) => "${selected} selected";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "networkWarningWhenLastBlock": m4,
