...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(seconds) => "${seconds} seconds ago";

  static String m4(days) => "${days} days";

  static String m5(hours) => "${hours} hrs";

  static String m6(minutes) => "${minutes} minutes";

  static String m7(seconds) => "${seconds} secs";

  static String m8(time) => " (${time} minutes ago)";

  static String m9(seconds) => "Next refresh in ${seconds} sec.";

  static String m10(verificationsCount) =>
      "Verifications: ${verificationsCount}";

  static String m11(amount) => "Tip must be greater or equal ${amount}";

  static String m12(version) => "Keyfile version ${version}";

  static String m13(separator, networkName, parsedRemainingTime) =>
      "Connecting to <${networkName}>${separator} Please wait... ${parsedRemainingTime}";

  static String m14(errorsCount) => "Found ${errorsCount} problems with server";

  static String m15(latestBlockTime) =>
  ...
  static String m16(seconds) => "Refresh in ${seconds} sec.";

  static String m17(availableAmountText, tokenDenominationModelName) =>
      "Available: ${availableAmountText} ${tokenDenominationModelName}";

  static String m18(hash) => "Transaction hash: 0x${hash}";

  static String m19(amount) => "+ ${amount} more";

  static String m20(widgetFeeTokenAmountModel) =>
      "Transaction fee ${widgetFeeTokenAmountModel}";

  static String m21(txMsgType) => "Preview for ${txMsgType} unavailable";

  static String m22(selected) => "${selected} selected";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "balancesButtonRequest": MessageLookupByLibrary.simpleMessage("Request"),
    "balancesDenomination": MessageLookupByLibrary.simpleMessage(
      "Denomination",
    ),
    "balancesHideSmall": MessageLookupByLibrary.simpleMessage(
      "Hide small balances",
    ),
    "balancesLastBlockTime": MessageLookupByLibrary.simpleMessage(
      "Last block time: ",
    ),
    "balancesName": MessageLookupByLibrary.simpleMessage("Name"),
    "balancesSearch": MessageLookupByLibrary.simpleMessage("Search balances"),
    "balancesSend": MessageLookupByLibrary.simpleMessage("Send"),
    "balancesTimeSinceBlock": m8,
    "block": MessageLookupByLibrary.simpleMessage("Block"),
    "blocks": MessageLookupByLibrary.simpleMessage("Blocks"),
    "blocksAge": MessageLookupByLibrary.simpleMessage("Age"),
    "blocksAppHash": MessageLookupByLibrary.simpleMessage("App Hash"),
    "blocksAverageTime": MessageLookupByLibrary.simpleMessage("Average time"),
    ...
    "blocksConsensusHash": MessageLookupByLibrary.simpleMessage(
      "Consensus Hash",
    ),
    "blocksCurrentHeight": MessageLookupByLibrary.simpleMessage(
      "Current height",
    ),
    "blocksCurrentTransactions": MessageLookupByLibrary.simpleMessage(
      "Current transactions",
    ),
    "blocksDate": MessageLookupByLibrary.simpleMessage("Date"),
    "blocksEvidenceHash": MessageLookupByLibrary.simpleMessage("Evidence Hash"),
    "blocksHash": MessageLookupByLibrary.simpleMessage("Hash"),
    "blocksHeight": MessageLookupByLibrary.simpleMessage("Height"),
    "blocksHintSearch": MessageLookupByLibrary.simpleMessage("Search blocks"),
    ...
    "blocksPendingTransactions": MessageLookupByLibrary.simpleMessage(
      "Pending transactions",
    ),
    "blocksProposer": MessageLookupByLibrary.simpleMessage("Proposer"),
    "blocksSinceGenesis": MessageLookupByLibrary.simpleMessage("Since genesis"),
    "blocksTxCount": MessageLookupByLibrary.simpleMessage("Tx Count"),
    "blocksValidatorHash": MessageLookupByLibrary.simpleMessage(
      "Validator Hash",
    ),
    "browse": MessageLookupByLibrary.simpleMessage("browse"),
    "buttonReportIssues": MessageLookupByLibrary.simpleMessage("Report issues"),
    "connectWallet": MessageLookupByLibrary.simpleMessage("Connect a Wallet"),
    "connectWalletButtonChangeNetwork": MessageLookupByLibrary.simpleMessage(
      "Change network",
    ),
    "connectWalletButtonRefreshNetwork": MessageLookupByLibrary.simpleMessage(
      "Refresh network",
    ),
    "connectWalletButtonSignIn": MessageLookupByLibrary.simpleMessage(
      "Sign in",
    ),
    "connectWalletConnecting": MessageLookupByLibrary.simpleMessage(
      "Connecting into account...",
    ),
    "connectWalletOptions": MessageLookupByLibrary.simpleMessage(
      "Choose one of the following options:",
    ),
    "connectWalletRefreshInfo": m9,
    "connectWalletRefreshed": MessageLookupByLibrary.simpleMessage("Refreshed"),
    "connectWalletRefreshing": MessageLookupByLibrary.simpleMessage(
      "Refreshing",
    ),
    "connectWalletWarning": MessageLookupByLibrary.simpleMessage(
    ...
    "consensusCurrentBlockValidator": MessageLookupByLibrary.simpleMessage(
      "Current Block Validator",
    ),
    "consensusHealthy": MessageLookupByLibrary.simpleMessage("Healthy"),
    "consensusState": MessageLookupByLibrary.simpleMessage("Consensus state"),
    ...
    "createWalletAddress": MessageLookupByLibrary.simpleMessage(
      "Your public address:",
    ),
    "createWalletAddressGenerating": MessageLookupByLibrary.simpleMessage(
      "Generating...",
    ),
    "createWalletButton": MessageLookupByLibrary.simpleMessage(
      "Create new wallet",
    ),
    "createWalletButtonGenerateAddress": MessageLookupByLibrary.simpleMessage(
      "Generate\nnew address",
    ),
    "createWalletDontHave": MessageLookupByLibrary.simpleMessage(
      "Don\'t have a wallet?",
    ),
    "createWalletTitle": MessageLookupByLibrary.simpleMessage(
      "Create a wallet",
    ),
    "creationDate": MessageLookupByLibrary.simpleMessage("Creation date"),
    "dashboard": MessageLookupByLibrary.simpleMessage("Dashboard"),
    "error": MessageLookupByLibrary.simpleMessage("Error"),
    "errorCannotFetchData": MessageLookupByLibrary.simpleMessage(
      "Cannot fetch data",
    ),
    ...
    "errorPreviewNotAvailable": MessageLookupByLibrary.simpleMessage(
      "Preview not available",
    ),
    "errorUndefined": MessageLookupByLibrary.simpleMessage("Undefined error"),
    ...
    "irAddCustomRecord": MessageLookupByLibrary.simpleMessage(
      "Add custom record",
    ),
    ...
    "irRecordDetails": MessageLookupByLibrary.simpleMessage(
    ...
    "irRecordStatusNotVerified": MessageLookupByLibrary.simpleMessage(
      "Not verified",
    ),
    "irRecordStatusPending": MessageLookupByLibrary.simpleMessage("Pending"),
    "irRecordStatusVerificationsCount": m10,
    ...
    "irTxHintVerifierWillGet": MessageLookupByLibrary.simpleMessage(
      "Verifier will get",
    ),
    "irTxTitleConfirmDeleteRecord": MessageLookupByLibrary.simpleMessage(
      "Confirm identity record deletion",
    ),
    "irTxTitleConfirmVerificationRequest": MessageLookupByLibrary.simpleMessage(
      "Confirm verification request",
    ),
    "irTxTitleRegisterIdentityRecord": MessageLookupByLibrary.simpleMessage(
    ...
    "irVerificationRequests": MessageLookupByLibrary.simpleMessage(
      "Verification Requests",
    ),
    "irVerificationRequestsActions": MessageLookupByLibrary.simpleMessage(
      "Actions",
    ),
    "irVerificationRequestsApprove": MessageLookupByLibrary.simpleMessage(
      "Approve",
    ),
    ...
    "irVerificationRequestsCreationDate": MessageLookupByLibrary.simpleMessage(
      "Creation date",
    ),
    "irVerificationRequestsFrom": MessageLookupByLibrary.simpleMessage("From"),
    ...
    "irVerificationRequestsRecords": MessageLookupByLibrary.simpleMessage(
      "Records",
    ),
    "irVerificationRequestsRecordsToVerify":
        MessageLookupByLibrary.simpleMessage("Records to verify"),
    "irVerificationRequestsReject": MessageLookupByLibrary.simpleMessage(
      "Reject",
    ),
    ...
    "irVerificationRequestsTip": MessageLookupByLibrary.simpleMessage("Tip"),
    "irVerificationRequestsVerifyRecord": MessageLookupByLibrary.simpleMessage(
      "Verify record",
    ),
    "irVerificationRequestsVerifyRecords": MessageLookupByLibrary.simpleMessage(
      "Verify records",
    ),
    "irWebsite": MessageLookupByLibrary.simpleMessage("Website"),
    "keyfile": MessageLookupByLibrary.simpleMessage("Keyfile"),
    "keyfileButtonDownload": MessageLookupByLibrary.simpleMessage("Download"),
    "keyfileCreatePassword": MessageLookupByLibrary.simpleMessage(
    ...
    "keyfileEnterPassword": MessageLookupByLibrary.simpleMessage(
      "Enter password",
    ),
    "keyfileErrorCannotBeEmpty": MessageLookupByLibrary.simpleMessage(
      "Keyfile cannot be empty",
    ),
    "keyfileErrorInvalid": MessageLookupByLibrary.simpleMessage(
      "Invalid Keyfile",
    ),
    "keyfileErrorPasswordsMatch": MessageLookupByLibrary.simpleMessage(
      "Passwords don\'t match",
    ),
    "keyfileErrorUnsupportedVersion": MessageLookupByLibrary.simpleMessage(
      "Unsupported version",
    ),
    "keyfileErrorWrongPassword": MessageLookupByLibrary.simpleMessage(
      "Wrong password",
    ),
    "keyfileHintPassword": MessageLookupByLibrary.simpleMessage("Password"),
    "keyfileHintRepeatPassword": MessageLookupByLibrary.simpleMessage(
      "Repeat password",
    ),
    "keyfileSignIn": MessageLookupByLibrary.simpleMessage(
    ...
    "keyfileTitleDownload": MessageLookupByLibrary.simpleMessage(
      "Download Keyfile",
    ),
    "keyfileToDropzone": MessageLookupByLibrary.simpleMessage(
      "Drop Keyfile to the dropzone",
    ),
    "keyfileToastDownloaded": MessageLookupByLibrary.simpleMessage(
      "Keyfile downloaded",
    ),
    "keyfileVersion": m12,
    ...
    "mnemonicEnter": MessageLookupByLibrary.simpleMessage(
      "Enter your Mnemonic",
    ),
    "mnemonicErrorEnterCorrect": MessageLookupByLibrary.simpleMessage(
      "You have to enter correct Mnemonic to sign in",
    ),
    "mnemonicErrorInvalid": MessageLookupByLibrary.simpleMessage(
      "Invalid mnemonic",
    ),
    "mnemonicErrorInvalidChecksum": MessageLookupByLibrary.simpleMessage(
      "Invalid checksum",
    ),
    "mnemonicErrorTooShort": MessageLookupByLibrary.simpleMessage(
      "Mnemonic too short",
    ),
    ...
    "mnemonicQrReveal": MessageLookupByLibrary.simpleMessage(
    ...
    "mnemonicSignIn": MessageLookupByLibrary.simpleMessage(
      "Sign in with Mnemonic",
    ),
    "mnemonicToastCopied": MessageLookupByLibrary.simpleMessage(
      "Mnemonic successfully copied",
    ),
    "mnemonicWordsButtonCopy": MessageLookupByLibrary.simpleMessage(
      "Copy mnemonic",
    ),
    "mnemonicWordsReveal": MessageLookupByLibrary.simpleMessage(
      "Reveal Mnemonic Words",
    ),
    "mnemonicWordsSelectAmount": MessageLookupByLibrary.simpleMessage(
    ...
    "networkBlockHeight": MessageLookupByLibrary.simpleMessage("Block Height"),
    "networkBlockTime": MessageLookupByLibrary.simpleMessage("Block time"),
    "networkButtonArrowTip": MessageLookupByLibrary.simpleMessage(
      "Go to the next page",
    ),
    "networkButtonCancelConnection": MessageLookupByLibrary.simpleMessage(
      "Cancel connection",
    ),
    "networkButtonCheckConnection": MessageLookupByLibrary.simpleMessage(
      "Check connection",
    ),
    "networkButtonConnect": MessageLookupByLibrary.simpleMessage("Connect"),
    "networkButtonConnected": MessageLookupByLibrary.simpleMessage("Connected"),
    "networkButtonConnecting": MessageLookupByLibrary.simpleMessage(
      "Connecting...",
    ),
    "networkCheckedConnection": MessageLookupByLibrary.simpleMessage(
      "Checked connection",
    ),
    "networkChoose": MessageLookupByLibrary.simpleMessage("Choose network"),
    "networkConnectingTo": m13,
    "networkConnectionCancelled": MessageLookupByLibrary.simpleMessage(
      "Connection cancelled",
    ),
    "networkConnectionEstablished": MessageLookupByLibrary.simpleMessage(
      "Connection established",
    ),
    "networkErrorAddressEmpty": MessageLookupByLibrary.simpleMessage(
      "Field can\'t be empty",
    ),
    "networkErrorAddressInvalid": MessageLookupByLibrary.simpleMessage(
      "Invalid network address",
    ),
    "networkErrorCannotConnect": MessageLookupByLibrary.simpleMessage(
      "Cannot connect to server",
    ),
    "networkErrorUndefinedName": MessageLookupByLibrary.simpleMessage(
      "undefined",
    ),
    "networkHintCustomAddress": MessageLookupByLibrary.simpleMessage(
      "Custom address",
    ),
    "networkHowManyProblems": m14,
    "networkList": MessageLookupByLibrary.simpleMessage("List of networks"),
    "networkNoAvailable": MessageLookupByLibrary.simpleMessage(
      "No available networks",
    ),
    "networkOtherServers": MessageLookupByLibrary.simpleMessage(
    ...
    "networkSelectServers": MessageLookupByLibrary.simpleMessage(
    ...
    "networkServerOfflineReason": MessageLookupByLibrary.simpleMessage(
      "Reason: Server is offline",
    ),
    "networkServerToConnect": MessageLookupByLibrary.simpleMessage(
      "Server you are trying to connect:",
    ),
    "networkSwitchCustomAddress": MessageLookupByLibrary.simpleMessage(
    ...
    "networkWarningWhenLastBlock": m15,
    "or": MessageLookupByLibrary.simpleMessage("or "),
    "paginatedListPageSize": MessageLookupByLibrary.simpleMessage("Page size"),
    ...
    "proposalsSuccessful": MessageLookupByLibrary.simpleMessage("Successful"),
    "proposalsVoters": MessageLookupByLibrary.simpleMessage("Voters"),
    "refresh": MessageLookupByLibrary.simpleMessage("Refresh"),
    "refreshInSeconds": m16,
    ...
    "stakingPoolAvailable": MessageLookupByLibrary.simpleMessage(
      "Staking Pool available",
    ),
    "stakingPoolDetails": MessageLookupByLibrary.simpleMessage(
      "Staking Pool Details",
    ),
    "stakingPoolLabelActions": MessageLookupByLibrary.simpleMessage("Actions"),
    "stakingPoolLabelCommission": MessageLookupByLibrary.simpleMessage(
      "Commission",
    ),
    "stakingPoolLabelSlashed": MessageLookupByLibrary.simpleMessage("Slashed"),
    "stakingPoolLabelTokens": MessageLookupByLibrary.simpleMessage("Tokens"),
    "stakingPoolLabelVotingPower": MessageLookupByLibrary.simpleMessage(
      "Voting Power",
    ),
    "stakingPoolStatusDisabled": MessageLookupByLibrary.simpleMessage(
      "Disabled",
    ),
    "stakingPoolStatusEnabled": MessageLookupByLibrary.simpleMessage("Enabled"),
    "stakingPoolStatusWithdraw": MessageLookupByLibrary.simpleMessage(
      "Withdraw Only",
    ),
    "stakingToEnable": MessageLookupByLibrary.simpleMessage(
      "To enable staking ",
    ),
    "stakingTxAmountToStake": MessageLookupByLibrary.simpleMessage(
      "Amount to stake",
    ),
    "stakingTxAmountToUnstake": MessageLookupByLibrary.simpleMessage(
      "Amount to unstake",
    ),
    "stakingTxButtonStake": MessageLookupByLibrary.simpleMessage("Stake"),
    "stakingTxClaimRewards": MessageLookupByLibrary.simpleMessage(
      "Claim all rewards",
    ),
    "stakingTxClaimUnstaked": MessageLookupByLibrary.simpleMessage(
      "Claim unstaked",
    ),
    "stakingTxConfirmStake": MessageLookupByLibrary.simpleMessage(
      "Confirm stake",
    ),
    "stakingTxConfirmUnstake": MessageLookupByLibrary.simpleMessage(
      "Confirm unstake",
    ),
    "stakingTxStakeTokens": MessageLookupByLibrary.simpleMessage(
      "Stake tokens",
    ),
    "stakingTxTokensToStake": MessageLookupByLibrary.simpleMessage(
      "Tokens to stake",
    ),
    "stakingTxTokensToUnstake": MessageLookupByLibrary.simpleMessage(
      "Tokens to unstake",
    ),
    "stakingTxUnstake": MessageLookupByLibrary.simpleMessage("Unstake"),
    "toYourAccount": MessageLookupByLibrary.simpleMessage(" to your account"),
    "toastCannotLoadDashboard": MessageLookupByLibrary.simpleMessage(
      "Cannot load dashboard. Please check your connection.",
    ),
    "toastHashCopied": MessageLookupByLibrary.simpleMessage(
      "Hash copied to clipboard",
    ),
    "toastPublicAddressCopied": MessageLookupByLibrary.simpleMessage(
      "Public address copied",
    ),
    "toastSuccessfullyCopied": MessageLookupByLibrary.simpleMessage(
      "Successfully copied",
    ),
    "transactionDetailsDrawerAmounts": MessageLookupByLibrary.simpleMessage(
      "Amounts",
    ),
    ...
    "transactionDetailsDrawerKey": MessageLookupByLibrary.simpleMessage("Key"),
    "transactionDetailsDrawerKeys": MessageLookupByLibrary.simpleMessage(
      "Keys",
    ),
    "transactionDetailsDrawerMessages": MessageLookupByLibrary.simpleMessage(
      "Messages",
    ),
    "transactionDetailsDrawerRecordIds": MessageLookupByLibrary.simpleMessage(
      "Record IDs",
    ),
    "transactionDetailsDrawerSenderWalletAddress":
        MessageLookupByLibrary.simpleMessage("Sender\'s wallet address"),
    "transactionDetailsDrawerTipAmount": MessageLookupByLibrary.simpleMessage(
      "Tip amount",
    ),
    "transactionDetailsDrawerTitle": MessageLookupByLibrary.simpleMessage(
      "Transaction details",
    ),
    "transactionDetailsDrawerValidatorKey":
        MessageLookupByLibrary.simpleMessage("Validator key"),
    "transactionDetailsDrawerValue": MessageLookupByLibrary.simpleMessage(
      "Value",
    ),
    ...
    "transactionsPageHintSearch": MessageLookupByLibrary.simpleMessage(
      "Search transactions",
    ),
    "transactionsPageTitle": MessageLookupByLibrary.simpleMessage(
      "Transactions",
    ),
    "tx": MessageLookupByLibrary.simpleMessage("Transactions"),
    "txAvailableBalances": m17,
    "txButtonBackToAccount": MessageLookupByLibrary.simpleMessage(
      "Back to account",
    ),
    "txButtonClaimAllRewards": MessageLookupByLibrary.simpleMessage(
      "Claim All Rewards",
    ),
    "txButtonClear": MessageLookupByLibrary.simpleMessage("Clear"),
    "txButtonConfirmSend": MessageLookupByLibrary.simpleMessage(
      "Confirm & send",
    ),
    "txButtonEdit": MessageLookupByLibrary.simpleMessage("Edit"),
    "txButtonEditTransaction": MessageLookupByLibrary.simpleMessage(
      "Edit transaction",
    ),
    ...
    "txCompleted": MessageLookupByLibrary.simpleMessage(
      "Transaction completed",
    ),
    "txConfirm": MessageLookupByLibrary.simpleMessage("Confirm transaction"),
    ...
    "txDateDropdownEndDate": MessageLookupByLibrary.simpleMessage("End date"),
    "txDateDropdownOneMonth": MessageLookupByLibrary.simpleMessage("1 month"),
    ...
    "txDateDropdownStartDate": MessageLookupByLibrary.simpleMessage(
      "Start date",
    ),
    "txDateDropdownToday": MessageLookupByLibrary.simpleMessage("Today"),
    "txDateDropdownYesterday": MessageLookupByLibrary.simpleMessage(
      "Yesterday",
    ),
    ...
    "txErrorFailed": MessageLookupByLibrary.simpleMessage("Transaction failed"),
    ...
    "txHash": m18,
    "txHintAmountToClaim": MessageLookupByLibrary.simpleMessage(
      "Amount to claim",
    ),
    ...
    "txHintUnstakeFrom": MessageLookupByLibrary.simpleMessage("Unstake from"),
    ...
    "txListAmountFeesOnly": MessageLookupByLibrary.simpleMessage("Fees only"),
    "txListAmountPlusFees": MessageLookupByLibrary.simpleMessage("+ fees"),
    "txListAmountPlusMore": m19,
    ...
    "txListDirectionOutbound": MessageLookupByLibrary.simpleMessage("Outbound"),
    ...
    "txListStatusConfirmed": MessageLookupByLibrary.simpleMessage("Confirmed"),
    ...
    "txMsgClaimRewards": MessageLookupByLibrary.simpleMessage(
      "Claim All Rewards",
    ),
    "txMsgClaimUndelegation": MessageLookupByLibrary.simpleMessage(
      "Claim Unstaked",
    ),
    "txMsgDelegate": MessageLookupByLibrary.simpleMessage("Stake Tokens"),
    "txMsgDeleteIdentityRecords": MessageLookupByLibrary.simpleMessage(
    ...
    "txMsgRequestIdentityRecordsVerify": MessageLookupByLibrary.simpleMessage(
      "Request Verification",
    ),
    "txMsgSendReceiveTokens": MessageLookupByLibrary.simpleMessage("Receive"),
    "txMsgSendSendTokens": MessageLookupByLibrary.simpleMessage("Send"),
    "txMsgUndefined": MessageLookupByLibrary.simpleMessage(
      "Unknown transaction type",
    ),
    "txMsgUndelegate": MessageLookupByLibrary.simpleMessage("Unstake Tokens"),
    "txNoticeFee": m20,
    "txPleaseSelectToken": MessageLookupByLibrary.simpleMessage(
      "Please select a token",
    ),
    "txPreviewUnavailable": m21,
    "txRecipientWillGet": MessageLookupByLibrary.simpleMessage(
      "Recipient will get",
    ),
    ...
    "txWarningDoNotCloseWindow": MessageLookupByLibrary.simpleMessage(
    ...
    "unstakedHintSearch": MessageLookupByLibrary.simpleMessage(
      "Search list of unstaked",
    ),
    "unstakedLabelLockedUntil": MessageLookupByLibrary.simpleMessage(
      "Locked until",
    ),
    "validator": MessageLookupByLibrary.simpleMessage("Validator"),
    "validators": MessageLookupByLibrary.simpleMessage("Validators"),
    "validatorsAbout": MessageLookupByLibrary.simpleMessage("About Validator"),
    "validatorsActive": MessageLookupByLibrary.simpleMessage("Active"),
    "validatorsButtonFilter": m22,
    "validatorsDropdownAll": MessageLookupByLibrary.simpleMessage("All"),
    "validatorsHintSearch": MessageLookupByLibrary.simpleMessage(
      "Search validators",
    ),
    ...
    "validatorsList": MessageLookupByLibrary.simpleMessage(
      "List of Validators",
    ),
    "validatorsPaused": MessageLookupByLibrary.simpleMessage("Paused"),
    "validatorsTableMoniker": MessageLookupByLibrary.simpleMessage("Moniker"),
