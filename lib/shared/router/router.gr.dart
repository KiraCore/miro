  ...
  List<_i9.RouteConfig> get routes => [
        _i9.RouteConfig(CoreRoute.name, path: '/', guards: [
          ...
          _i9.RouteConfig(CreateWalletRoute.name,
              ...
              parent: CoreRoute.name,
              guards: [urlPathGuard]),
          _i9.RouteConfig(LoginKeyfileRoute.name,
              path: 'login-keyfile',
              parent: CoreRoute.name,
              guards: [urlPathGuard]),
          _i9.RouteConfig(LoginMnemonicRoute.name,
              path: 'login-mnemonic',
              parent: CoreRoute.name,
              guards: [urlPathGuard]),
...
class LoginKeyfileRoute extends _i9.PageRouteInfo<void> {
...
class LoginMnemonicRoute extends _i9.PageRouteInfo<void> {
