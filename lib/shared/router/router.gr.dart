...
import '../../views/pages/drawer/login_page/login_saifu_page.dart' as _i8;
...
import '../../views/pages/menu/welcome_page/welcome_page.dart' as _i10;
...
class AppRouter extends _i11.RootStackRouter {
  ...
  final Map<String, _i11.PageFactory> pagesMap = {
    ...
    LoginSaifuRoute.name: (routeData) {
      return _i11.CustomPage<void>(
          routeData: routeData,
          child: const _i8.LoginSaifuPage(),
          opaque: true,
          barrierDismissible: false);
    },
  ...
  List<_i11.RouteConfig> get routes => [
        _i11.RouteConfig(PagesRoute.name, path: '/', children: [
          _i11.RouteConfig(AccountsRoute.name,
              path: 'accounts', parent: PagesRoute.name),
          _i11.RouteConfig(DashboardRoute.name,
              path: 'dashboard', parent: PagesRoute.name),
          _i11.RouteConfig(CreateWalletRoute.name,
              path: 'create-wallet', parent: PagesRoute.name),
          _i11.RouteConfig(ConnectionRoute.name,
              path: 'connection', parent: PagesRoute.name),
          _i11.RouteConfig(LoginKeyfileRoute.name,
              path: 'login-keyfile', parent: PagesRoute.name),
          _i11.RouteConfig(LoginMnemonicRoute.name,
              path: 'login-mnemonic', parent: PagesRoute.name),
          _i11.RouteConfig(LoginSaifuRoute.name,
              path: 'login-saifu', parent: PagesRoute.name),
          _i11.RouteConfig(ValidatorsRoute.name,
...
class PagesRoute extends _i11.PageRouteInfo<void> {
  const PagesRoute({List<_i11.PageRouteInfo>? children})
...
class ConnectionRoute extends _i11.PageRouteInfo<void> {
...
class LoginKeyfileRoute extends _i11.PageRouteInfo<void> {
...
/// generated route for [_i10.WelcomePage]
