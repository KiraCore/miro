  ...
  static AProposalTypeContentModel buildFromDto(AProposalTypeContent proposalTypeContent, ProposalType proposalType) {
    switch (proposalType) {
      ...
      case ProposalType.softwareUpgrade:
        return ProposalSoftwareUpgradeModel.fromDto(proposalTypeContent as ProposalSoftwareUpgrade);
      case ProposalType.assignPermission:
        return ProposalAssignPermissionModel.fromDto(proposalTypeContent as ProposalAssignPermission);
      ...
      case ProposalType.upsertTokenAlias:
        return ProposalUpsertTokenAliasModel.fromDto(proposalTypeContent as ProposalUpsertTokenAlias);
