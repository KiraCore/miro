...
void main() {
  ...
  final UnsafeWallet actualUnsafeWallet = UnsafeWallet.derive(mnemonic: actualMnemonic);
  final KeyFile actualKeyfile = KeyFile(wallet: actualUnsafeWallet, version: KeyFile.latestVersion);
  ...
  final WalletAddress expectedAddress = WalletAddress(addressBytes: expectedAddressBytes, bech32Hrp: actualUnsafeWallet.address.bech32Hrp);
  ...
  final UnsafeWallet expectedWallet = UnsafeWallet(address: expectedAddress, privateKey: expectedPrivateKey, publicKey: expectedPublicKey);
