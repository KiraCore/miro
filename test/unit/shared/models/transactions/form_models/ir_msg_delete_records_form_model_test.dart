...
void main() {
  CosmosWalletAddress actualSenderAddress = CosmosWalletAddress.fromBech32('kira143q8vxpvuykt9pq50e6hng9s38vmy844n8k9wx');
  ...
  group('Tests of IRMsgDeleteRecordsFormModel.canBuildTxMsg()', () {
    ...
    test('Should [return FALSE] if at least one of required form fields not exists (walletAddress)', () {
      ...
      IRMsgDeleteRecordsFormModel actualIRMsgDeleteRecordsFormModel = IRMsgDeleteRecordsFormModel(
        irRecordModels: <IRRecordModel>[
          const IRRecordModel(id: '0', key: 'key1', value: 'value', verifiersAddresses: <CosmosWalletAddress>[], pendingVerifiersAddresses: <CosmosWalletAddress>[]),
        ],
        walletAddress: null,
      );
