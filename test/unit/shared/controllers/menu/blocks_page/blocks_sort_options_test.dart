...
void main() {
  ...
  BlockModel height592BlockModel = BlockModel(
      blockId: BlockId(hash: '17D483817A8CEA195CE1C6BC3B40295DB2B9D97D8C49B9F2A2E5F5E9022FC9A0'),
      blockSize: '914',
      header: Header(
  ...
  BlockModel height591BlockModel = BlockModel(
      blockId: BlockId(hash: '7877F93BA228CA8A9C960B16FC42BFD10D3060DFD198390066486107EC4D8804'),
      blockSize: '914',
      header: Header(
  ...
  BlockModel height589BlockModel = BlockModel(
      blockId: BlockId(hash: 'C59DB15217584A0DB17C9F4C1B1F241D34C28E80A95ED8A5833BC5E83F3000E3'),
      blockSize: '914',
      header: Header(
  ...
  BlockModel height588BlockModel = BlockModel(
      blockId: BlockId(hash: '498F60C0C1E981774BED3F4E7532FE1CB187A917820E6F7E93696D8D75DB2980'),
      blockSize: '914',
      header: Header(
  ...
  group('Tests of BlocksSortOptions.sortByTop', () {
    test('Should return blockList by "height" ascending', () {
      ...
      expect(actualBlockModelList, expectedBlockModelList);
    });
