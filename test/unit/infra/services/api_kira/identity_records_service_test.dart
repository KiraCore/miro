...
Future<void> main() async {
  ...
  final CosmosWalletAddress actualWalletAddress = CosmosWalletAddress.fromBech32('kira143q8vxpvuykt9pq50e6hng9s38vmy844n8k9wx');
  ...
  final IRModel expectedRequesterIRModel = IRModel(
    walletAddress: CosmosWalletAddress.fromBech32('kira143q8vxpvuykt9pq50e6hng9s38vmy844n8k9wx'),
  ...
  final IRUserProfileModel expectedIrUserProfileModel = IRUserProfileModel(
    walletAddress: CosmosWalletAddress.fromBech32('kira177lwmjyjds3cy7trers83r4pjn3dhv8zrqk9dl'),
    username: 'somnitear',
