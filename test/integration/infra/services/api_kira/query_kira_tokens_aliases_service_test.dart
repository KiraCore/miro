...
Future<void> main() async {
  ...
  final QueryKiraTokensAliasesService actualQueryKiraTokensAliasesService =
  ...
  group('Tests of QueryKiraTokensAliasesService.getTokenAliases() method', () {
    test('Should return [List of TokenAliasModel]', () async {
      ...
      try {
        List<TokenAliasModel> actualTokenAliasModelList =
            await actualQueryKiraTokensAliasesService.getTokenAliasModels();
        ...
        TestUtils.printError(
            'query_kira_tokens_aliases_service_test.dart: Cannot parse [List<TokenAliasModel>] for URI $networkUri: ${e}');
      } catch (e) {
  ...
  group('Tests of QueryKiraTokensAliasesService.getTokenDefaultDenomModel() method', () {
    test('Should return [TokenDefaultDenomModel]', () async {
      TestUtils.printInfo('Data request');
      try {
        TokenDefaultDenomModel actualTokenDefaultDenomModel =
            await actualQueryKiraTokensAliasesService.getTokenDefaultDenomModel(networkUri);
        ...
        TestUtils.printError(
            'query_kira_tokens_aliases_service_test.dart: Cannot fetch [TokenDefaultDenomModel] for URI $networkUri: ${e.dioException.message}');
      } on DioParseException catch (e) {
        TestUtils.printError(
            'query_kira_tokens_aliases_service_test.dart: Cannot parse [TokenDefaultDenomModel] for URI $networkUri: ${e}');
      } catch (e) {
        TestUtils.printError('query_kira_tokens_aliases_service_test.dart: Unknown error for URI $networkUri: ${e}');
      }
    });
