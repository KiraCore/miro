...
Future<void> main() async {
  ...
  group('Tests of QueryDelegationsService.getValidatorStakingModelList() method', () {
    test('Should return [List<ValidatorStakingModel>]', () async {
      ...
      try {
        List<ValidatorStakingModel> actualValidatorStakingModelList =
            await actualQueryDelegationsService.getValidatorStakingModelList(actualQueryDelegationsReq);

        TestUtils.printInfo('Data return');
        print(actualValidatorStakingModelList);
        print('');
      } on DioConnectException catch (e) {
        TestUtils.printError('query_delegations_service_test.dart: Cannot fetch [List<ValidatorStakingModel>] for URI $networkUri: ${e.dioException.message}');
      } on DioParseException catch (e) {
        TestUtils.printError('query_delegations_service_test.dart: Cannot parse [List<ValidatorStakingModel>] for URI $networkUri: ${e}');
      } catch (e) {
